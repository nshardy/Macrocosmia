    ...
    fun getPath() : String {
        ...
        when {
            osName.startsWith("Windows") -> {
                if (! File(System.getProperty("user.home") + "\\Documents\\Macrocosmia\\worlds\\").exists())
                    Files.createDirectories(Path(System.getProperty("user.home") + "\\Documents\\Macrocosmia\\worlds\\"))

                return System.getProperty("user.home") + "\\Documents\\Macrocosmia\\worlds\\"
            }
